...
class AppTheme {
  ...
  static TextTheme get textTheme => TextTheme(
    displayLarge:  GoogleFonts.manrope(fontSize: 57, fontWeight: FontWeight.w800),
  ...
  static ThemeData get light => ThemeData(
    ...
    chipTheme: ChipThemeData(
      ...
      labelStyle: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w700, letterSpacing: 1.5),
    ...
    navigationBarTheme: NavigationBarThemeData(
      ...
      labelTextStyle: WidgetStateProperty.all(
        GoogleFonts.inter(fontSize: 0), // no labels per DESIGN.md
      ),
    ),
  );
}