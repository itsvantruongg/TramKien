      ...
      body: CustomScrollView(slivers: [
          ...
          child: SafeArea(child: Padding(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('CẬP NHẬT MỚI NHẤT', style: Theme.of(context).textTheme.labelSmall
        ...
        if (_loading)
          ...
          const SliverFillRemaining(child: Center(child: Column(
            ...
            children: [
              Icon(Icons.notifications_none, size: 56, color: AppTheme.outlineVariant),
              SizedBox(height: 12),
...
class _NotifCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SurfaceCard(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(notif.title, style: Theme.of(context).textTheme.titleSmall
            ?.copyWith(fontWeight: FontWeight.w700)),
        const SizedBox(height: 4),
        Text(notif.body, style: Theme.of(context).textTheme.bodySmall
            ?.copyWith(color: AppTheme.onSurfaceVariant), maxLines: 3,
            overflow: TextOverflow.ellipsis),
        const SizedBox(height: 4),
        Text(_ago(notif.ts), style: Theme.of(context).textTheme.labelSmall
